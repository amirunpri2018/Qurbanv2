        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Daftar Pengurban</span>
                </div>
                <div class="tools"> </div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="pengurban">
                    <thead>
                    <tr>
                        ...
                        <th class="desktop">Status Pembayaran</th>
        ...
        var initTable1 = function () {
            ...
            var oTable = table.dataTable({
                ...
                ajax: {
                    ...
                    {data: 'statusPembayaran', name: 'statusPembayaran', render : function(data) {
                        if (data == 'Lunas'){

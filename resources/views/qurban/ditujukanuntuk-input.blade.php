...
@section('title',"Input Data Ditujukan Untuk")
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="{{route('input.ditujukanuntuk')}}" class="form-horizontal" method="post">
                        @csrf
                        <div class="form-body">
                            ...
                            <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="nama" class="form-control input-circle" placeholder="Masukkan Nama Ditujukan Untuk">
                                    @if ($errors->has('nama'))
                                        <span class="help-block">
